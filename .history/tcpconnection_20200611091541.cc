...
int TcpConnection::send(Buffer &buffer)
{
    if(_channel)
    {
        ...
        {
            std::cout << "11111111111111xxxxx11111111111111" << std::endl;
            if(ret.second == -2) { std::cout << "11111111111111xxxxx11111111111111" << std::endl; _channel->close();}
...
int TcpConnection::send(const char *msg, size_t len)
{
    if(_channel)
    {
        ...
        {
            std::cout << "1111111111111111yyyyy111111111111" << std::endl;
            _channel->close();
        }
