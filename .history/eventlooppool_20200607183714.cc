#include "eventlooppool.h"
	...
	EventLoopThread::EventLoopPool(EventLoop::Ptr ptr, size_t threadnum)
	: _main_eventloop(ptr)
	...
	EventLoopThread::~EventLoopPool() {}
	
	EventLoop::Ptr EventLoopThread::choose()
	{
		if(!_loop.size())	
		{ 
	...
	static EventLoopPool &EventLoopThread::getInstance(EventLoop::Ptr ptr = nullptr, size_t threadnum = 0)
	{
